<template>
  <section class="profile_feedback">
    ...
    <div class="profile_feedback_field">
      <div class="feedback_current_time">{{ currentDate | date_format }}</div>
      <mt-field
        label="意见反馈"
        placeholder="您好！感谢使用在线考试系统,我是您的客服小助理。如果您对本系统有什么建议或者有话对我说，请直接留言给我。我会尽快答复您的哟！一经采纳将会有小奖品喔"
        type="textarea"
        rows="6"
        v-model="feedback"
      />
    ...
    <div
      v-show="showEmotion"
      id="emotionDiv"
      style="z-index: 999;background-color: #ffffff;position: relative;top: 5px"
    >
