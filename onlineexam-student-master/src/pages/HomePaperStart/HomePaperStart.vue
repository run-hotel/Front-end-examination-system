  ...
  <section class="paper">
    ...
    <div class="paper_sub_title_first">
      <span class="paper_date"
        >考试日期：{{ currentDate | date_format('YYYY-MM-DD') }}</span
      >
      <span class="paper_duration"
        >考试时长：{{ paperInfo.paperDuration / 60 }}分钟</span
      >
    </div>

    <!--时间提醒和当前题数-->
    <div class="paper_sub_title_second">
      <span class="paper_clock"
        ><i class="iconfont iconjishiqi"></i>{{ restTime }}</span
      >
      <span class="paper_statistics"
        ><i class="iconfont icontongji"></i>{{ currentIndex + 1 }}/{{
          queNumInfo.totalNum
        }}</span
      >
    </div>
    ...
    <div class="paper_container" v-show="showPaperContainer">
      ...
      >
        <div class="content">
          ...
          <span class="que_content"
            >{{ index + 1 }}.&nbsp;{{ item.singleContent
            }}<span class="que_score"
              >[{{ paperInfo.singleScore }}分]</span
            ></span
          >
      ...
      <section
        class="que"
        v-for="(item, index) in multipleQueList"
      ...
      >
        <div class="content">
          ...
          <span class="que_content"
            >{{ index + 1 + queNumInfo.singleNum }}.&nbsp;{{
              item.multipleContent
            }}<span class="que_score"
              >[{{ paperInfo.multipleScore }}分]</span
            ></span
          >
      ...
      <section
        ...
        v-show="
          index + queNumInfo.singleNum + queNumInfo.multipleNum == currentIndex
        "
      >
        <div class="content">
      ...
      <div class="paper_button">
        <mt-button
          type="primary"
          @click.native="preItem"
          :disabled="currentIndex < 1"
          >{{ currentIndex < 1 ? '无' : '上一题' }}
        </mt-button>
        <mt-button
          type="primary"
    ...
    <div class="paper_card" v-show="showPaperCard">
      ...
      <div class="card_options">
        ...
        <div class="options">
          ...
          <div class="row">
            <div
              class="item"
              v-for="(singleItem, singleIndex) in queNumInfo.singleNum"
              :key="singleIndex"
            >
              <div
        ...
        <div class="options">
          ...
          <div class="row">
            <div
              class="item"
              v-for="(multipleItem, multipleIndex) in queNumInfo.multipleNum"
              :key="multipleIndex"
            >
              <div
                @click="toPaperQue(multipleItem + queNumInfo.singleNum)"
                :class="{
                  complete_flag:
                    JSON.stringify(multipleAnswers[multipleIndex]) !== '[]' &&
                    JSON.stringify(multipleAnswers[multipleIndex]) !==
                      undefined &&
        ...
        <div class="options">
          ...
          <div class="row">
            <div
              class="item"
              v-for="(judgeItem, judgeIndex) in queNumInfo.multipleNum"
              :key="judgeIndex"
            >
              <div
                @click="
                  toPaperQue(
                    judgeItem + queNumInfo.singleNum + queNumInfo.multipleNum
                  )
                "
                :class="{
        ...
        <div class="options">
          ...
          <div class="row">
            <div
              class="item"
              v-for="(fillItem, fillIndex) in queNumInfo.fillNum"
              :key="fillIndex"
            >
              <div
                @click="
      ...
      <div class="card_button">
        <mt-button type="primary" @click.native="clickSubmit"
          >提交试卷并查看成绩</mt-button
        >
      </div>
    </div>
...
export default {
  ...
  created() {
    ...
    this.getPaperInfoByPaperId(() => {
      ...
      if (
        !sessionStorage.getItem('sno' + this.sno + 'paperId' + this.paperId)
      ) {
    ...
    async insertStudentPaperScore() {
      ...
      if (result.statu == 0) {
        sessionStorage.setItem(
          'sno' + this.sno + 'paperId' + this.paperId,
          result.msg
        )
      } else {
        Toast({
  ...
  watch: {
    ...
    multipleAnswers: function() {
      ...
      sessionStorage.setItem(
        'multipleAnswers',
        JSON.stringify(this.multipleAnswers)
      )
    },
    judgeAnswers() {
      sessionStorage.removeItem('judgeAnswers')
