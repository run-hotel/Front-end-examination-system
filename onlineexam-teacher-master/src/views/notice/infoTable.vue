<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input
        v-model="listQuery.noticeContent"
        placeholder="搜索公告"
        clearable
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>{{ scope.row.noticeCreateTime | date_format }}</span>
        </template>
      </el-table-column>
      <el-table-column
        label="操作"
...
export default {
  ...
  methods: {
    ...
    async handleFilter() {
      ...
      this.listLoading = true
      let result = await reqSearchNoticesList(
        this.listQuery.noticeContent,
